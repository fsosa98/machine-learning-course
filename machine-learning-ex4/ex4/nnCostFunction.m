...
J = (1/m) * sum(sum(-y2.*log(sigmoid(a * Theta2')) - (1-y2).*log(1-sigmoid(a * Theta2'))));
...
Theta1_grad = (1/m) * grad_1;
Theta2_grad = (1/m) * grad_2;

% Part 3
t1 = Theta1;
t1(:,1) = zeros(1,size(t1,1))';
t2 = Theta2;
t2(:,1) = zeros(1,size(t2,1))';
